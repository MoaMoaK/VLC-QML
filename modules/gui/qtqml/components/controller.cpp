                           ...
                           : AbstractController( _p_i, _parent )
{
    ...
    f_opacity = var_InheritFloat( p_intf, "qtqml-fs-opacity" );
#endif

    i_sensitivity = var_InheritInteger( p_intf, "qtqml-fs-sensitivity" );
    ...
    i_screennumber = var_InheritInteger( p_intf, "qtqml-fullscreen-screennumber" );
