...
#undef audioCommon
            ...
            int i_max_volume = config_GetInt( p_intf, "qtqml-max-volume" );
...
//            ui.defaultLabel->setFont( italicFont );
            ...
            CONFIG_BOOL( "qtqml-minimal-view", minimalviewBox );
            ...
            CONFIG_BOOL( "qtqml-video-autoresize", resizingBox );
            CONNECT( ui.embedVideo, toggled( bool ), ui.resizingBox, setEnabled( bool ) );
            ui.resizingBox->setEnabled( ui.embedVideo->isChecked() );

            CONFIG_BOOL( "qtqml-fs-controller", fsController );
            CONFIG_BOOL( "qtqml-system-tray", systrayBox );
            CONFIG_GENERIC( "qtqml-notification", IntegerList, ui.notificationComboLabel,
                                                      notificationCombo );
            ...
            CONFIG_BOOL( "qtqml-pause-minimized", pauseMinimizedBox );
            ...
            /* UPDATE options */
#ifdef UPDATE_CHECK
            CONFIG_BOOL( "qtqml-updates-notif", updatesBox );
            CONFIG_GENERIC_NO_BOOL( "qtqml-updates-days", Integer, NULL,
                    updatesDays );
            ...
            CONFIG_BOOL( "qtqml-recentplay", saveRecentlyPlayed );
            CONFIG_GENERIC( "qtqml-continue", IntegerList, ui.continuePlaybackLabel, continuePlaybackComboBox );
            CONFIG_GENERIC( "qtqml-recentplay-filter", String, ui.filterLabel,
                    recentlyPlayedFilters );
            CONFIG_GENERIC( "qtqml-auto-raise", IntegerList, ui.autoRaiseLabel, autoRaiseComboBox );
        ...
        case SPrefsHotkeys:
        {
            ...
            p_config = config_FindConfig( "qtqml-disable-volume-keys" );
