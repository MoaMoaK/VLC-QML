...
{
    /* Volume keys */
    _p_intf->p_sys->disable_volume_keys = var_InheritBool( _p_intf, "qtqml-disable-volume-keys" );
...
{
    p_intf->p_sys->disable_volume_keys = var_InheritBool( p_intf, "qtqml-disable-volume-keys" );
