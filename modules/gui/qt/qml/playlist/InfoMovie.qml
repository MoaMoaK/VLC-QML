        ...
        Rectangle {
            ...
            Row {
                ...
                Text {
                    ...
                    MouseArea {
                        anchors.fill: parent
                        onClicked: {pl_item.back(); selector.setSourceFromName(2)}
                    }
                }
                ...
                Text {
                    ...
                    MouseArea {
                        anchors.fill: parent
                        onClicked: {pl_item.back(); selector.setSourceFromName(3)}
                    }
                }
                ...
                Text {
                    ...
                    MouseArea {
                        anchors.fill: parent
                        onClicked: {pl_item.back(); selector.setSourceFromName(4)}
                    }
                }
